...
**If pip install failed on the droplet** (e.g. scipy Cython/nogil error), fix the venv first: see **FIX_DROPLET_PIP_THEN_SERVICE.md** (install scipy from wheel, then requirements, then this).
